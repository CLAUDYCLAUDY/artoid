...

{
  ref: "livre-01",
  categorie: "Ouvrage",
  collection: "Archives Sélectives",
  enLigne: true,
  statut: "Disponible",
  titre: "Riviera, un été 1968",
  public: "Adultes",
  prix: "48 €",
  format: "24 × 30 cm",
  pages: "144 pages",
  fabrication: "Quadrichromie, dos toilé, reliure cousue",
  tirage: "Tirage numéroté à 500 exemplaires",
  isbn: "",
...

{
  ...
  enLigne: true,
  statut: "Disponible",
  titre: "Formes de la Méditerranée",
  public: "Adultes",
  prix: "54 €",
  format: "21 × 28 cm",
  pages: "208 pages",
  fabrication: "Impression deux tons, reliure suisse",
  tirage: "Tirage numéroté à 700 exemplaires",
  isbn: "",
...

{
  ...
  format: "20 × 26 cm",
  pages: "120 pages",
  fabrication: "Papier mat, jaquette dépliante",
  tirage: "Tirage numéroté à 400 exemplaires",
  isbn: "",
...

{
  ref: "livre-04",
  categorie: "Ouvrage",
  collection: "The Stories",
  enLigne: true,
  statut: "Disponible",
  titre: "Le Fantôme qui n'avait peur de rien",
  public: "Dès 4 ans",
  prix: "19 €",
  format: "22 × 26 cm",
  pages: "40 pages cartonnées",
  fabrication: "Illustrations à la gouache, cahiers cousus",
  tirage: "",
  isbn: "",
...

{
  ...
  enLigne: true,
  statut: "Disponible",
  titre: "Abécédaire des choses belles",
  public: "Dès 3 ans",
  prix: "22 €",
  format: "24 × 24 cm",
  pages: "60 pages",
  fabrication: "Quadrichromie, couverture cartonnée",
  tirage: "",
  isbn: "",
...

{
  ...
  enLigne: true,
  statut: "Disponible",
  titre: "Formes, tout simplement",
  public: "Dès 18 mois",
  prix: "16 €",
  format: "18 × 18 cm",
  pages: "24 pages épaisses",
  fabrication: "Pages cartonnées, coins arrondis, vernis résistant",
  tirage: "",
  isbn: "",
...

{
  ref: "objet-01",
  categorie: "Objet",
  collection: "Objets édités",
  enLigne: true,
  statut: "Disponible",
  titre: "Tote bag Artoid",
  public: "",
  prix: "28 €",
  format: "38 × 42 cm",
  pages: "",
  fabrication: "Coton épais 320 g, sérigraphie une couleur, fabrication européenne",
  tirage: "",
  isbn: "",
  accroche: "Le sac qui porte les livres.",
  description: "Coton épais, anses longues, sérigraphie une couleur au dessin de la maison. Assez solide pour trois beaux livres, assez sobre pour tous les jours.",
  points: ["Coton épais 320 g", "Sérigraphie une couleur", "Fabrication européenne", "Anses longues"]
},

{
  ...
  enLigne: true,
  statut: "Disponible",
  titre: "Affiche sérigraphiée",
  public: "",
  prix: "45 €",
  format: "50 × 70 cm",
  pages: "",
  fabrication: "Sérigraphie deux couleurs sur papier 250 g, édition limitée",
  tirage: "Édition limitée à 100 exemplaires numérotés",
  isbn: "",
  accroche: "Une image de la maison, tirée à cent exemplaires.",
  description: "Sérigraphie deux couleurs sur papier épais, numérotée et signée au crayon. Expédiée en tube rigide, prête à encadrer.",
  points: ["Sérigraphie deux couleurs", "Papier 250 g", "100 exemplaires numérotés", "Expédition en tube rigide"]
},

{
  ...
  format: "A5",
  pages: "128 pages",
  fabrication: "Couverture toilée, papier ivoire 90 g, reliure cousue",
  tirage: "",
  isbn: "",
  accroche: "Pour prendre des notes comme on prépare un livre.",
  description: "Couverture toilée, papier ivoire agréable au stylo-plume, reliure cousue qui laisse le carnet ouvert à plat. Pages blanches.",
  points: ["Couverture toilée", "Papier ivoire 90 g", "Reliure cousue, ouverture à plat", "128 pages blanches"]
},

{
  ...
  enLigne: true,
  statut: "Disponible",
  titre: "Marque-pages, coffret de 4",
  public: "",
  prix: "12 €",
  format: "5 × 18 cm",
  pages: "",
  fabrication: "Papier 350 g, impression deux tons",
  tirage: "",
  isbn: "",
  accroche: "Quatre marque-pages, pour quatre livres commencés.",
  description: "Quatre marque-pages imprimés en deux tons sur papier épais, réunis dans un étui. Motifs tirés des ouvrages de la maison.",
  points: ["Coffret de 4", "Papier 350 g", "Impression deux tons", "Motifs issus du catalogue"]
}
